	...
	export default {
		...
		methods: {
			async loadData(options) {
				...
				core.get('AppMember/getDocument',{code:options.code},function(data){
					if(data){
						uni.hideLoading();
						that.show = !0;
						that.title = data.document_title;
						that.createtime = data.document_time;
						that.content = data.document_content;
					}
				});
			}
		}
